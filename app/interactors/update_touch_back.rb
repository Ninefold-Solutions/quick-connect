class UpdateTouchBack < ApplicationService
  ...
  def add_event
    contact.events.create(user: actor, action: "touched", action_for_context: "updated follow up after for", trackable: contact, action_context: "updated follow up timeline to  #{touch_back_after.humanize}")
  end
