class Event < ApplicationRecord
  ACTIONS = ["created", "task", "unarchived", "event", "noted", "called", "archived", "relation", "commented", "conversation", "debt", "deleted", "gifted", "document", "contact_activity", "contact_event", "reminder", "about", "added_user", "deactivated", "activated", "batch", "reminder", "about", "removed", "group", "track", "untrack", "imported", "touched", "collection", "deleted_collection"].freeze
